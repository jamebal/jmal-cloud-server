...
@Component
@Slf4j
public class MyPropertiesUserManager extends AbstractUserManager {
     ...
     */
    public MyPropertiesUserManager() {
    ...
    public User authenticate(Authentication authentication)
        ...
        if (authentication instanceof UsernamePasswordAuthentication path) {

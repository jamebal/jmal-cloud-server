...
public class WebsiteSettingDAOJpaImpl implements IWebsiteSettingDAO, IWriteCommon<WebsiteSettingDO> {
    ...
    public WebsiteSettingDO findOne() {
        ...
        try {
            ...
            if (setting.isPresent()) {
                ...
                WebsiteSettingDO websiteSettingDO = new WebsiteSettingDO();
                CompletableFuture<Void> future = writeService.submit(new WebSiteSettingOperation.Create(websiteSettingDO));
    ...
    public void updateLogo(String logo) {
        ...
        try {
            ...
            CompletableFuture<Integer> future = writeService.submit(new WebSiteSettingOperation.UpdateNetdiskLogo(logo));
    ...
    public void updateName(String name) {
        ...
        try {
            ...
            CompletableFuture<Integer> future = writeService.submit(new WebSiteSettingOperation.UpdateNetdiskName(name));
            int updatedCount = future.get(10, TimeUnit.SECONDS);
    ...
    public void upsert(WebsiteSettingDO websiteSettingDO) {
        ...
        try {
            ...
            if (existingSetting.isPresent()) {
                ...
                writeService.submit(new WebSiteSettingOperation.Create(existing));
            } else {
                ...
                writeService.submit(new WebSiteSettingOperation.Create(websiteSettingDO));
            }
        } catch (Exception e) {
    ...
    public void updatePreviewConfig(String iframe) {
        ...
        try {
            ...
            CompletableFuture<Integer> future = writeService.submit(new WebSiteSettingOperation.UpdateIframe(iframe.trim()));
            int updatedCount = future.get(10, TimeUnit.SECONDS);
    ...
    public void setMfaForceEnable(Boolean mfaForceEnable) {
        ...
        try {
            ...
            CompletableFuture<Integer> future = writeService.submit(new WebSiteSettingOperation.UpdateMfaForceEnable(mfaForceEnable));
            int updatedCount = future.get(10, TimeUnit.SECONDS);
    ...
    @Override
    public void AsyncSaveAll(Iterable<WebsiteSettingDO> entities) {
        writeService.submit(new WebSiteSettingOperation.CreateAll(entities));
    }
}

...
public class PdfCoverTest {
    public static void main(String[] args) {
        try {
            ...
            File pdfFile = new File("/Users/jmal/temp/filetest/rootpath/jmal/jmal/1001241328 JLG BIM Content User Guide - Boom Lift.pdf");
    ...
    private static File pdfCoverImage(File pdfFile) throws IOException, TikaException {
        ...
        try (PDDocument document = Loader.loadPDF(new RandomAccessReadBufferedFile(pdfFile))) {
            ...
            BufferedImage coverImage = pdfRenderer.renderImageWithDPI(0, 300, ImageType.RGB);
